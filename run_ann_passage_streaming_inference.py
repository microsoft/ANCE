...
def GetPassProcessingFunct(args, tokenizer):
    def fn(line, i):
        passage_collection = []
...
def main():
    ...
    with open(query_collection_path, 'r', encoding='utf8') as f:
    ...
    with open(passage_collection_path, "r", encoding="utf-8") as f:
        StreamInferenceDoc(args, passage_collection_path, model, GetPassProcessingFunct(args, tokenizer), "passage_", f, is_query_inference = False)
